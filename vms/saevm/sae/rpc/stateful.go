...
// tracerAPI serves debug_traceCall with [traceCallBackend], which reports
// state as of the requested block, and every other tracing endpoint with
// [tracerBackend], which re-executes blocks. This mirrors the
